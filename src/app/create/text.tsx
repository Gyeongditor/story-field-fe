...
export default function CreateText() {
  ...
  const [body, setBody] = useState(params.voiceText || '');
  ...
  const goNext = () => {
    ...
    // TODO: 실제 생성 API 연결 시 전달 데이터 구성
    Alert.alert('생성 준비', `${title} / ${protagonist} / ${mood} / ${artStyle} / ${dialect}`);
  };
  ...
  return (
    <Container>
      ...
      <Footer>
        <GhostButton onPress={() => (step === 1 ? router.back() : setStep(1))}>
